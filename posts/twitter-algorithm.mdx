---
title: Due Diligence Report: Vertex International Securities ETF (VIS-ETF)
publishedAt: 2025-11-11
summary: "This report provides a comprehensive due diligence analysis of the Vertex International Securities Exchange Traded Fund (VIS-ETF), Tanzania's first ETF. It recommends a 'chill for now' approach due to structural flaws."
image: "/images/twitter-algorithm.jpeg"
---

This report provides a comprehensive due diligence analysis of the Vertex International Securities Exchange Traded Fund (VIS-ETF), Tanzania's first ETF listed on the Dar es Salaam Stock Exchange (DSE).

The primary recommendation is for a prospective investor to "chill for now and monitor it."

The VIS-ETF is a landmark and innovative product, critical for the evolution of Tanzanian capital markets (Source). It successfully provides investors with "single trade" access to a high-growth, concentrated basket of Tanzanian blue-chip financial and investment companies (Source). Its Initial Public Offer (IPO) was overwhelmingly successful, achieving a 136% oversubscription rate, demonstrating immense domestic demand (Source). This product operates within a strong macroeconomic environment, with Tanzania's real GDP growth projected at 6% for 2025 (Source).

However, the recommendation to "chill" is based on tangible, severe, and identifiable structural flaws evident in the fund's initial launch phase. Investing at this moment introduces risks that are, for a prudent investor, unacceptable. These risks are not related to the quality of the underlying companies but to the structure of the ETF wrapper itself.
